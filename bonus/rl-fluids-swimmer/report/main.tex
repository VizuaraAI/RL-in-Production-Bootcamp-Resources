...
\emph{eight-number} Q-table rediscovers the published non-reciprocal cycle; the reciprocal
baseline measures $-0.0003$ body displacements over 24 strokes --- the theorem confirmed by
...
\begin{figure}[h]
\centering
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\textwidth]{../figures/nav_traj_naive.png}\end{subfigure}
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\textwidth]{../figures/nav_traj_smart.png}\end{subfigure}
\begin{subfigure}{0.32\textwidth}\includegraphics[width=\textwidth]{../figures/nav_policy_field.png}\end{subfigure}
...
Q-learning ($\gamma = 0.9$, 300 episodes of 24 strokes, $\sim$40 s) converges to the
cycle $(E,E) \to (C,E) \to (C,C) \to (E,C) \to \cdots$ --- precisely the published
non-reciprocal stroke, discovered from reward alone. Over 24 strokes:
