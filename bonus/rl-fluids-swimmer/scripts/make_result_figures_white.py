"""WHITE-PALETTE variant of make_result_figures.py for the project site + README.

Same computations, same real runs — only the palette differs (pure white, the
Vizuara production-study register). Auto-generated from make_result_figures.py.
...
PAPER, PANEL, INK, INK3, RULE = "#FFFFFF", "#FFFFFF", "#1F1E1A", "#5C626F", "#E8EAEF"
BLUE, RED, GOLD, GREEN, PLUM, GREY = "#2196C9", "#D400BC", "#E39A3E", "#2F7D5C", "#9AA1AC", "#C9CDD4"
